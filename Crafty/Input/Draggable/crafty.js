...
Crafty.c("Draggable", {
  _origMouseDOMPos: null,
	...
	* #.dragDirection
	* @comp Draggable
	* @sign public this .dragDirection([Object dir])
  * @param dir - if omitted, no specific direction. If specified, must be in the form of {x: valx, y: valy}, which denotes the direction by the vector (valx, valy).
